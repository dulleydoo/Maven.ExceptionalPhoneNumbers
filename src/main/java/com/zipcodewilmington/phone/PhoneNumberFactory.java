...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createRandomPhoneNumber() {
        return createPhoneNumberSafely(RandomNumberFactory.createInteger(302, 302), RandomNumberFactory.createInteger(100, 999), RandomNumberFactory.createInteger(1000, 9999));
    }
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        try{
            ...
            logger.info("Cannot create number");
            return null;
        }
    }
...
//        logger.info("New phone number " + phoneNumberString);
